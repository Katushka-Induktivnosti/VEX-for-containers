...
def modified_jaccard(df1, df2, df3, df4, df5, df6):
    ...
    set5 = set(df5['VulnerabilityID'].astype(str) + "/" +  df5['Container'].astype(str)) #+ "/" + df5['Severity'].astype(str).str.upper())
    set6 = set(df6['VulnerabilityID'].astype(str) + "/" +  df6['Container'].astype(str)) #+ "/" + df6['Severity'].astype(str).str.upper())
    #set7 = set(df7['VulnerabilityID'].astype(str) + "/" +  df7['Container'].astype(str)) #+ "/" + df7['Severity'].astype(str).str.upper())


    intersection = set1.intersection(set2).intersection(set3).intersection(set4).intersection(set5).intersection(set6)
    union = set1.union(set2).union(set3).union(set4).union(set5).union(set6)
