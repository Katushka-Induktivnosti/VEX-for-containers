...
def modified_jaccard(df1, df2, df3, df4, df5):
    ...
    intersection = set1.intersection(set2).intersection(set3).intersection(set4).intersection(set5)
    union = set1.union(set2).union(set3).union(set4).union(set5)
